/**
 * Top-level renderer composition root.
 * Owns startup bootstrapping, preload bridge subscriptions, lightweight
 * bootstrap state, and the handoff into the main shell component tree.
 */
import {
  Component,
  startTransition,
...
import type { AppState, DiscoveredLogCandidate } from "../../shared/models/types";
import {
  buildPlayerRows,
  ...
  type DetailTab,
  type View
} from "../state/analysisViewModel";
import {
  ObsidianScreens
} from "../shell/ObsidianScreens";
import { DEFAULT_SETTINGS, type ProfileSettings } from "../state/rendererSettings";
import { DEFAULT_ENCOUNTER_INACTIVITY_TIMEOUT_MS } from "../../shared/config/constants";
import { createInitialAuxiliarySummary } from "../../shared/models/auxiliaryLogs";
