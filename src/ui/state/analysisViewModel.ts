/**
 * Renderer-side analysis projections.
 * Converts canonical combat snapshots into the player, target, and encounter
 * rows the UI can sort, filter, and drill into efficiently.
 */
import type {
  ActivationStat,
...
import {inferBuildFromSkills} from "../metadata/nwMetadata";
import {normalizeEntityName} from "../../shared/models/mechanicsModel";
