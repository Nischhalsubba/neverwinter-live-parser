/**
 * Neverwinter metadata lookup helpers.
 * Centralizes visual and class/power lookup logic so renderer views do not
 * duplicate fragile matching rules.
 */
...
import type { SkillStat } from "../../shared/models/types";
