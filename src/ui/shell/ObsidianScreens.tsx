/**
 * Primary desktop shell and major renderer views.
 * This module currently hosts the main app chrome plus the largest view
 * surfaces until the UI is split into smaller feature modules.
 */
...
} from "../../shared/models/mechanicsModel";
import type {
  AppState,
...
import { classifyPowerFamily, getClassVisualMeta, getPowerMeta, getPowerVisualMeta, isKnownCompanion } from "../metadata/nwMetadata";
import type { DetailTab, LiveScopeMode, PlayerRow, View } from "../state/analysisViewModel";
import {
  DETAIL_TABS,
  formatDuration,
  formatNumber,
...
import type { ProfileSettings } from "../state/rendererSettings";
