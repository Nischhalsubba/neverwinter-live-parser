...
/**
 * Gameplay mechanics model helpers.
 * Houses categorization and derived-rating utilities used by the library and
 * analytics surfaces for richer Neverwinter-specific context.
 */
