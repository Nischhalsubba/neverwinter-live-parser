 ...
 * Exposes the narrow, typed API surface the renderer is allowed to use while
 * keeping context isolation enabled.
 */
...
import type { ErrorLogEntry } from "./services/errorLogger.js";
