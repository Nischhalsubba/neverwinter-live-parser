 ...
 * Owns the desktop window lifecycle, runtime hardening, IPC handlers, and the
 * bridge between the parser engine and the renderer shell.
 */
...
import { LogMonitorService } from "../../engine/monitoring/logMonitorService.js";
import {
  clearErrorLogs,
  getLogDirectory,
  listErrorLogs,
