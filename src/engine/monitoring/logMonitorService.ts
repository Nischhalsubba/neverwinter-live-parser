 ...
 * Coordinates file watching, incremental reads, auxiliary log ingestion,
 * encounter segmentation, recording archives, and state emission.
 */
...
import { createInitialAuxiliarySummary } from "../../shared/models/auxiliaryLogs.js";
import { DEFAULT_ENCOUNTER_INACTIVITY_TIMEOUT_MS } from "../../shared/config/constants.js";
import { CombatantTracker } from "../aggregation/combatantTracker.js";
import { detectActiveLogFile } from "../watching/detectActiveLog.js";
import {
  createInitialReaderState,
  readAppendedLines,
  type ReaderState
} from "../reading/incrementalReader.js";
import { splitBufferedLines } from "../reading/lineBuffer.js";
import { parseLine } from "../parsing/parseLine.js";
import {
  applyAuxiliaryEventToSummary,
  classifyAuxiliaryLogKind,
  parseAuxiliaryLogLine
} from "../parsing/parseAuxiliaryLogLine.js";
import { EncounterManager } from "../encounters/encounterManager.js";
