/**
 * Worker-thread import entry point.
 * Parses large recorded logs off the main Electron thread so imports remain
 * responsive while producing the canonical app state shape.
 */
...
import type { AppState, CombatEvent, ParseIssue } from "../../shared/models/types.js";
