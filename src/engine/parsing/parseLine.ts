/**
 * Primary Neverwinter combat-log parser.
 * Converts raw combat lines into canonical combat events or structured parse
 * issues without leaking parser concerns into the rest of the engine.
 */
import type { CombatEvent, ParseIssue } from "../../shared/models/types.js";
import { getNwHubArtifact } from "../../shared/models/nwHubArtifacts.js";
