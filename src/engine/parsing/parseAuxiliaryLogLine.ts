...
/**
 * Auxiliary Neverwinter log parser.
 * Normalizes voice-chat, client-server, crash, shutdown, and related side
 * channel logs into structured events the app can summarize.
 */
import type {
  AuxiliaryLogEvent,
  AuxiliaryLogKind,
...
export { createInitialAuxiliarySummary } from "../../shared/models/auxiliaryLogs.js";
